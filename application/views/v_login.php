      ...
      <div class="login-box">
        <form class="login-form" method="post" action="#">  
          ...
          <div class="form-group btn-container">
            <button type='button' onclick="ceklogin()" class="btn btn-primary btn-block"><i class="fa fa-sign-in fa-lg fa-fw"></i>SIGN IN</button>
          </div>
        </form>
...
function ceklogin(){
    ...
    var password = $("#password").val();
      ...
      url   : url,
      type  : "POST",
      data  : {"username":username,"password":password}, //"username" merupakan variabel yg akan disesuaikan dg  $_POST ('username')
      dataType: "JSON",
